Function Scaffold-CsTemplate([String]$Template, [String]$Project, [String]$OutputPath)
{
    ...
    $ControllerNamespace = "MVC5Test.Controllers"
    $ControllerTestsNamespace = "MVC5Test.Tests.Unit.Controllers"
    If ($Area) { $ControllerNamespace = "MVC5Test.Controllers.$Area" }
    If ($Area) { $ControllerTestsNamespace = "MVC5Test.Tests.Unit.Controllers.$Area" }
...
Function Scaffold-AreaRegistration([String]$Template, [String]$Project, [String]$OutputPath)
{
    if (!$Delete)
    {
        $ControllerNamespace = "MVC5Test.Controllers.$Area"
        $ControllerTestsNamespace = "MVC5Test.Tests.Unit.Controllers.$Area"
