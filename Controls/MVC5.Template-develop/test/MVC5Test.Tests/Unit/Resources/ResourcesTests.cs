...
namespace MVC5Test.Tests.Unit.Resources
{
    public class ResourcesTests
    {
        ...
        {
            ResourceManager manager = MVC5Test.Resources.Permission.Area.Titles.ResourceManager;
        ...
        {
            ResourceManager manager = MVC5Test.Resources.Permission.Controller.Titles.ResourceManager;
            using (Context context = new Context())
            {
        ...
        {
            ResourceManager manager = MVC5Test.Resources.Permission.Action.Titles.ResourceManager;
            using (Context context = new Context())
            {
        ...
        public void Resources_HasEquivalents()
        {
            ...
            IEnumerable<Type> types = Assembly
                .Load("MVC5Test.Resources")
                .GetTypes()
                .Where(type => type.Namespace.StartsWith("MVC5Test.Resources."));
