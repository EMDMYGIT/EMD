using MVC5Test.Controllers.Administration;
using System;
using System.Web.Mvc;
using System.Web.Routing;
using Xunit;

namespace MVC5Test.Tests.Unit.Controllers.Administration
{
    public class AdministrationAreaRegistrationTests
    {
        ...
        public void RegisterArea_MultilingualRoute()
        {
            ...
            Assert.Equal(new[] { "MVC5Test.Controllers.Administration" }, actual.DataTokens["Namespaces"] as String[]);
