...
namespace ContosoUniversityTutorial.DAL
{
    public class SchoolInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        ...
        protected override void Seed(SchoolContext context)
        {
            ...
            students.ForEach(s => context.Students.Add(s));// .AddOrUpdate(p => p.LastName, s));
            context.SaveChanges();
            ...
            instructors.ForEach(s => context.Instructors.Add(s)); //.AddOrUpdate(p => p.LastName, s));
            context.SaveChanges();
            ...
            departments.ForEach(s => context.Departments.Add(s));//.AddOrUpdate(p => p.Name, s));
            context.SaveChanges();
            ...
            courses.ForEach(s => context.Courses.Add(s));//.AddOrUpdate(p => p.CourseID, s));
            context.SaveChanges();
            ...
            officeAssignments.ForEach(s => context.OfficeAssignments.Add(s));//.AddOrUpdate(p => p.InstructorID, s));
            context.SaveChanges();
