...
namespace DBClases
{
    ...
    public class clsDtaUtils
    {
        ...
        #endregion
        #region Filters
        public List<Contacts.Models.FiltersModels.CityFilter> RetrieveContactCities(String Filter)
        {
            try
            {
                conn.Open();
        ...
        private List<Contacts.Models.FiltersModels.CityFilter> GetAllCities(DataSet pDS)
        {
            try
            {
                List<Contacts.Models.FiltersModels.CityFilter> bMList = new List<Contacts.Models.FiltersModels.CityFilter>();

                foreach (DataRow item in pDS.Tables[0].Rows)
                {
                    Contacts.Models.FiltersModels.CityFilter TempModel = new Contacts.Models.FiltersModels.CityFilter();
        ...
        public List<Contacts.Models.FiltersModels.CountryFilter> RetrieveContactCountries(String Filter)
        {
            try
            {
                conn.Open();
        ...
        private List<Contacts.Models.FiltersModels.CountryFilter> GetAllCountries(DataSet pDS)
        {
            try
            {
                List<Contacts.Models.FiltersModels.CountryFilter> bMList = new List<Contacts.Models.FiltersModels.CountryFilter>();

                foreach (DataRow item in pDS.Tables[0].Rows)
                {
                    Contacts.Models.FiltersModels.CountryFilter TempModel = new Contacts.Models.FiltersModels.CountryFilter();
