...
namespace DBClases
{
    ...
    public class clsDtaUtils
    {
        ...
        #endregion
        #region FiltersList
        public List<Contacts.Models.CityFilter> RetrieveContactCities(String Filter)
        {
            try
            {
                conn.Open();
                // Insert code to process data.
                string sSql = @"select distinct City   FROM [dbo].[TB_Contact] ";
                if (Filter != string.Empty) sSql = sSql + " where 1=2 " + Filter;
        ...
        private List<Contacts.Models.CityFilter> GetAllCities(DataSet pDS)
        {
            try
            {
                List<Contacts.Models.CityFilter> bMList = new List<Contacts.Models.CityFilter>();

                foreach (DataRow item in pDS.Tables[0].Rows)
                {
                    Contacts.Models.CityFilter TempModel = new Contacts.Models.CityFilter();
                   TempModel.Caption= item["City"].ToString();
        ...
        public List<Contacts.Models.CountryFilter> RetrieveContactCountries(String Filter)
        {
            try
            {
                conn.Open();
                // Insert code to process data.
                string sSql = @"select distinct Country   FROM [dbo].[TB_Contact] ";
                if (Filter != string.Empty) sSql = sSql + " where 1=2 " + Filter;
        ...
        private List<Contacts.Models.CountryFilter> GetAllCountries(DataSet pDS)
        {
            try
            {
                List<Contacts.Models.CountryFilter> bMList = new List<Contacts.Models.CountryFilter>();

                foreach (DataRow item in pDS.Tables[0].Rows)
                {
                    Contacts.Models.CountryFilter TempModel = new Contacts.Models.CountryFilter();
                    TempModel.Caption = item["Country"].ToString();
        ...
        #endregion
        #region FiltersGrid
        public List<Contacts.Models.FiltersModels.CityFilterGrid> RetrieveContactCitiesGrid(String Filter)
        {
            try
            {
                conn.Open();
        ...
        private List<Contacts.Models.FiltersModels.CityFilterGrid> GetAllCities_Grid(DataSet pDS)
        {
            try
            {
                List<Contacts.Models.FiltersModels.CityFilterGrid> bMList = new List<Contacts.Models.FiltersModels.CityFilterGrid>();

                foreach (DataRow item in pDS.Tables[0].Rows)
                {
                    Contacts.Models.FiltersModels.CityFilterGrid TempModel = new Contacts.Models.FiltersModels.CityFilterGrid();
                    TempModel.CityName = item["City"].ToString();
        ...
        public List<Contacts.Models.FiltersModels.CountryFilterGrid> RetrieveContactCountriesGrid(String Filter)
        {
            try
            {
                conn.Open();
                ...
                System.Data.DataSet DS = new DataSet();
                DA.Fill(DS, "Country");
                return GetAllCountries_Grid(DS);
            }
            catch (Exception ex)
            {
                throw new System.ArgumentException("Erroron RetrieveContactData", ex);
        ...
        private List<Contacts.Models.FiltersModels.CountryFilterGrid> GetAllCountries_Grid(DataSet pDS)
        {
            try
            {
                List<Contacts.Models.FiltersModels.CountryFilterGrid> bMList = new List<Contacts.Models.FiltersModels.CountryFilterGrid>();

                foreach (DataRow item in pDS.Tables[0].Rows)
                {
                    Contacts.Models.FiltersModels.CountryFilterGrid TempModel = new Contacts.Models.FiltersModels.CountryFilterGrid();
                    TempModel.CountryName = item["Country"].ToString();
